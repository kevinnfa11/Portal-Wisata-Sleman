...
<div class="main">
	<div class="row">
		<div class="container">
			...
			<div class="col-lg-8 mx-auto my-5">	
			 <div class="card">
			 	<div class="card-header text-center bg-success text-white">Tambah Tempat Rekreasi</div>
			 	<div class="card-body">
				@if(count($errors) > 0)
				...
				<form action="/admin/rekreasi/proses" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}
 ...
 <br>
 <br>
 <h4> Daftar Data Tempat Rekreasi </h4>
        <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$g->keterangan}}</td>
                            <td><a class="btn btn-danger" href="/admin/rekreasi/hapus/{{ $g->id }}">HAPUS</a></td>
                            <td><a class="btn btn-success" href="/admin/rekreasi/edit/{{ $g->id }}">Edit</a></td>
