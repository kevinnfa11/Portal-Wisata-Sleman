                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                <form action="/admin/monjali/proses" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <button type="submit" class="btn btn-primary">Upload</button>
                            ...
                            @endforeach
                                ...
                                <div class="post-content">
                                    ...
                                    <tr>
                                        <td>{{$g->keterangan}}</td>
                                        <td><a class="btn btn-danger" href="/admin/monjali/hapus/{{ $g->id }}">HAPUS</a></td>
                            <td><a class="btn btn-success" href="/admin/monjali/edit/{{ $g->id }}">Edit</a></td>
                                    </tr>
                                    @endforeach
                                  </table>
