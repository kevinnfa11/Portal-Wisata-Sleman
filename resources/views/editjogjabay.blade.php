...
<div class="main">
	...
	@foreach($jogjabays as $p)

<div class="container">
<form action="/admin/jogjabay/update" method="post">
		{{ csrf_field() }}
		<center>
<div class="card">
    		...
    		<tbody>
				...
				<tr>
						...
						<td><input type="submit" value="Simpan Data">
							<td><a href="/admin/jogjabay" class="btn btn-primary btn-lg float-right" tabindex="-1" role="button">Kembali</a></td>
					</td>
				</tr>
