	...
	<div class="row">
		<div class="container">
			...
			<div class="col-lg-8 mx-auto my-5">	
			 <div class="card">
			 	<div class="card-header text-center bg-success text-white">Tambah Tempat Kuliner</div>
			 	<div class="card-body">
				@if(count($errors) > 0)
				...
				<form action="/admin/kuliner/proses" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}
        ...
        <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$g->keterangan}}</td>
                            <td><a class="btn btn-danger" href="/admin/kuliner/hapus/{{ $g->id }}">HAPUS</a></td>
                            <td><a class="btn btn-success" href="/admin/kuliner/edit/{{ $g->id }}">Edit</a></td>
