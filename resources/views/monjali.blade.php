...
<div class="row">
    ...
    <div class="breadcumb-area" style="background-image: url(image/monjali.jpeg);">
    ...
    <section class="single_blog_area section_padding_80">
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="col-10 col-sm-11">
                            ...
                            @endforeach
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="#">
                                        <h2 class="post-headline">Museum Monjali Saksi Sejarah di Yogyakarta</h2>
                                    <br>
                                    </a>
                                    <a href="#">
                ...
                <!-- Post Thumb -->
                    <img src="image/monjalikuliner.jpg" alt="">
                <!-- Overlay Text -->
                     </div>

                     <div class="welcome-single-slide">
                <!-- Post Thumb -->
                    <img src="image/parkirmonjali.jpg" alt="">
                <!-- Overlay Text -->
                     </div>
                     <div class="welcome-single-slide">
                <!-- Post Thumb -->
                    <img src="image/parkirmonjali2.jpg" alt="">
                <!-- Overlay Text -->
                     </div>
...
<div class="container">
  ...
  <div id="imgtext"></div>
    ...
    <tbody>
      ...
      <div class="fb-comments" data-href="http://127.0.0.1:8001/monjali" data-width="" data-numposts="5"></div>                                
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="single-widget-area popular-post-widget">
                        ...
                        <img src="image/alamat1.png"   style="width:30px;"  ><b> Alamat :</b>
                                       <p class="text-muted">Gemangan, Sinduadi
Mlati
Sleman Regency
Special Region of Yogyakarta
                                       </p>
                        <div class="map">
                            <a href="https://www.google.co.id/maps/place/Monjali+St,+Gemangan,+Sinduadi,+Mlati,+Sleman+Regency,+Special+Region+of+Yogyakarta/@-7.760456,110.3672311,17z/data=!3m1!4b1!4m5!3m4!1s0x2e7a58565260814f:0x7c3cb4a3185877ef!8m2!3d-7.760456!4d110.3694198"><img src="image/monjalimap.jpg" class="img-thumbnail"  style="width:250px;"> </a>
                        </div>
